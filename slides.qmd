...
- <b>Optimal Embedding Dimensions:</b> The best performance was achieved with 7 embedding dimensions, reaching an accuracy of 87.34% on the test dataset.
- <b>Robust Performance:</b> The model demonstrated competitive and consistent accuracy even with higher dimensions and minimal data preprocessing.
- <b>Limited Vocabulary and Input:</b> The model was trained on the top 5000 most common words and limited input sequences to the first 500 words, yet remained effective.
- <b>Semantic Relationships:</b> The model successfully captured semantic relationships, shown by coherent similar words for terms like "awful," "mediocre," "perfect," and "favorite."
- <b>Avoiding Overfitting:</b> Training was limited to 10 epochs to prevent overfitting, maintaining the model's accuracy and reliability for practical sentiment analysis applications.
