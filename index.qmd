...
names(train_processed) = c('text','polarity')
names(test_processed) = c('text','polarity')
```
...
# combine training and testing together
ds <- rbind(test_processed, train_processed)
...
```{r}
emb.history <- embedding_model %>% keras3::fit(
  train_x, train_y, 
  epochs = 6,
  batch_size = 32,
