...
## Data Visualization
- The Umap below shows the location of where all the words are embedded on a 2D plane. The words of the IMDB dataset are clustered densely around the origin of the graph.
```{r Umap}
library(ggplot2)
